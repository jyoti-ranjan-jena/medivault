...
//   // Generate the last 7 days array securely
//   for (let i = 6; i >= 0; i--) {
...
//       <div
//         className={`p-3 rounded-2xl ${colorClass} bg-opacity-10 backdrop-blur-sm group-hover:scale-110 transition-transform`}
//       >
//         <Icon
//           size={24}
//           className={colorClass.replace("bg-", "text-").split(" ")[0]}
//         />
//       </div>
//       {trend && (
...
//     </div>
//     <div>
//       <h3 className="text-3xl font-extrabold text-text-main tracking-tight tabular-nums">
//         {value}
//       </h3>
...
//         // 2. TIMEZONE-SAFE: Calculate Today's Revenue
//         const todayStr = getLocalDateString(new Date());
//         const todayBills = bills.filter(
//           (b) => getLocalDateString(new Date(b.createdAt)) === todayStr,
//         );
//         const revenueToday = todayBills.reduce(
...
//           value={`₹${stats.todayRevenue.toLocaleString()}`} // 🔴 REAL DATA FORMATTED
//           icon={IndianRupee}
...
//             </div>
//             <div
//               className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${stats.lowStockItems.length > 0 ? "bg-red-50 text-status-danger" : "bg-emerald-50 text-status-success"}`}
//             >
...
//                 <div
//                   key={med._id}
//                   className="flex items-center justify-between p-4 rounded-xl border border-red-100 bg-red-50/50 hover:bg-red-50 transition-colors"
//                 >
